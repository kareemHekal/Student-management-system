...
class Forthday extends StatefulWidget {
  final String? level;
  Forthday({this.level, super.key});

  @override
  _ForthdayState createState() => _ForthdayState();
}

class _ForthdayState extends State<Forthday> with SingleTickerProviderStateMixin {
  late TabController _tabController;

  @override
  void initState() {
    super.initState();
    // Initialize the TabController with one tab
