          ...
          return Container(
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  // Day Picker
                  _buildDropdown("D A Y S", "Select a day", cubit.days, cubit.chosenDay, (value) => cubit.selectDay(value)),
                  ...
                  // Grade Picker
                  _buildDropdown("G R A D E", "Select a secondary", cubit.secondaries, cubit.selectedSecondary, (value) => cubit.selectSecondary(value)),
      ...
      children: [
        ...
        DropdownButton<String>(
          ...
          items: items.map((item) {
            return DropdownMenuItem(value: item, child: Text(item, style: const TextStyle(color: app_colors.orange)));
          }).toList(),
          ...
          icon: const Icon(Icons.arrow_forward_ios_outlined, color: app_colors.orange),
        ),
      ],
    );
  }
