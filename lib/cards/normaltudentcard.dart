...
class normalStudentWidget extends StatelessWidget {
  ...
  normalStudentWidget({required this.studentModel, required this.grade, super.key});
                ...
                Row(
                  ...
                  children: [
                    ...
                    ElTooltip(
                      ...
                      content: Text(studentModel.note??"there is no note"),
                      child: ClipRRect(
  ...
  Widget _buildStudentDaysList() {
    List<Map<String, dynamic>> daysWithTimes = [
      {
        'day': studentModel.firstDay,
        'time': studentModel.firstDayTime
      },
      {
        'day': studentModel.secondDay,
        'time': studentModel.secondDayTime
      },
      {
        'day': studentModel.thirdDay,
        'time': studentModel.thirdDayTime
      },
      {
        'day': studentModel.forthday,
        'time': studentModel.forthdayTime
      }
    ];
...
// Helper function to format TimeOfDay to 12-hour format with AM/PM
  String _formatTime12Hour(TimeOfDay time) {
    final int hour = time.hourOfPeriod == 0 ? 12 : time.hourOfPeriod; // Convert 0 to 12 for midnight/noon
    final String period = time.period == DayPeriod.am ? 'AM' : 'PM';
    final String minute = time.minute.toString().padLeft(2, '0'); // Ensure two digits for minutes
